 ...
 */
roleRoutes.post('/role/paginate', roleController.paginate);
 ...
 *         description: Error interno del servidor
 */
roleRoutes.get('/role/all', roleController.all);
 ...
 *         description: Error interno del servidor
 */
roleRoutes.post('/role/create', roleController.create);
 ...
 *         description: Error interno del servidor
 */
roleRoutes.put('/role/:id', roleController.update);
 ...
 *         description: Error interno del servidor
 */
roleRoutes.get('/role/:id', roleController.getById);
 ...
 *         description: Error interno del servidor
 */
roleRoutes.delete('/role/:id', roleController.remove);
